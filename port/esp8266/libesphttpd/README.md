...
# Using libesphttpd in Mist

Compile the library using the Makefile in this directory. A
libesphttpd.a file will be generated, that library can then be used in
the Mist esp8266 project.
